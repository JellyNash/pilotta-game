// UI Debugging Tools for Pilotta Game
window.UIDebugger = {
  ...
  testResponsiveness() {
    const breakpoints = [
      { name: 'Mobile Small', width: 480, height: 854 },
    ...
    breakpoints.forEach(({ name, width, height }) => {
      ...
      label.style.cssText = `
        ...
        top: 50%;
        left: 50%;
        transform: translate(-50%, calc(-50% - ${height/2}px - 30px));
        background: #333;
        color: white;
        padding: 5px 15px;
        border-radius: 5px;
...
console.log('  - UIDebugger.testResponsiveness()');